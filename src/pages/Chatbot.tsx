        ...
        if (activeConversation) {
          ...
          if (parsedConversation && parsedConversation.userId === user.id) {
            ...
            setCurrentConversation({
              ...
              endedAt: parsedConversation.conversation.endedAt ? 
                new Date(parsedConversation.conversation.endedAt) : null,
                ...
                {!currentConversation ? (
                  ...
                  <div className="space-y-4">
                    {currentConversation.messages.length === 0 ? (
                      ...
                      currentConversation.messages.map((chat) => (
                        <div 
                          key={chat.id}
            ...
            <form onSubmit={handleSubmit} className="p-4 border-t border-gray-200">
              <div className="flex space-x-2">
                ...
                <Button 
                  ...
                  disabled={isLoading || !currentConversation || !message.trim()}
                >
